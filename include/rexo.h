...
#define RXP_DEFINE_PARAMS(TYPE)                                                \
    _Pragma("warning(push)")                                                   \
        _Pragma("warning(disable : 4100)") struct rx_context *RX_PARAM_CONTEXT \
            RXP_MAYBE_UNUSED,                                                  \
        TYPE *RX_PARAM_DATA RXP_MAYBE_UNUSED _Pragma("warning(pop)")
#else
#define RXP_DEFINE_PARAMS(TYPE)                                                \
...
#define RXP_LANG_VERSION 0L
    ...
    || (!defined(RX_ENABLE_NPRINTF) && !defined(_MSC_VER)                      \
...
#define RXP_HAS_NPRINTF 1
    ...
    || (!defined(RX_ENABLE_VARIADIC_MACROS) && !defined(_MSC_VER)              \
        && ((RXP_LANG == RXP_LANG_C && RXP_LANG_VERSION < 199901L)             \
            || (RXP_LANG == RXP_LANG_CPP && RXP_LANG_VERSION < 201103L)))
...
#define RX_SET_UP(ID) static enum rx_status ID(RXP_DEFINE_PARAMS(void))

#define RX_TEAR_DOWN(ID) static void ID(RXP_DEFINE_PARAMS(void))

#if RXP_HAS_VARIADIC_MACROS
#define RX_FIXTURE(...)                                                        \
    RXP_EXPAND(RXP_CONCAT(RXP_FIXTURE_DISPATCH_,                               \
                          RXP_HAS_AT_LEAST_3_ARGS(__VA_ARGS__))(__VA_ARGS__))  \
    RXP_REQUIRE_SEMICOLON

#define RXP_FIXTURE_DISPATCH_0(ID, TYPE) RXP_FIXTURE_0(ID, sizeof(TYPE))

#define RXP_FIXTURE_DISPATCH_1(ID, TYPE, ...)                                  \
    RXP_FIXTURE_1(ID, sizeof(TYPE), RXP_COUNT_ARGS(__VA_ARGS__), (__VA_ARGS__))
#else
...
#define RX_VOID_FIXTURE(...)                                                   \
    RXP_EXPAND(RXP_CONCAT(RXP_VOID_FIXTURE_DISPATCH_,                          \
                          RXP_HAS_AT_LEAST_2_ARGS(__VA_ARGS__))(__VA_ARGS__))  \
    RXP_REQUIRE_SEMICOLON

#define RXP_VOID_FIXTURE_DISPATCH_0(ID) RXP_FIXTURE_0(ID, 0)

#define RXP_VOID_FIXTURE_DISPATCH_1(ID, ...)                                   \
    RXP_FIXTURE_1(ID, 0, RXP_COUNT_ARGS(__VA_ARGS__), (__VA_ARGS__))
#else
...
#define RX_TEST_SUITE(...)                                                     \
    RXP_EXPAND(RXP_CONCAT(RXP_TEST_SUITE_DISPATCH_,                            \
                          RXP_HAS_AT_LEAST_2_ARGS(__VA_ARGS__))(__VA_ARGS__))  \
    RXP_REQUIRE_SEMICOLON

#define RXP_TEST_SUITE_DISPATCH_0(ID) RXP_TEST_SUITE_0(ID)

#define RXP_TEST_SUITE_DISPATCH_1(ID, ...)                                     \
    RXP_TEST_SUITE_1(ID, RXP_COUNT_ARGS(__VA_ARGS__), (__VA_ARGS__))
#else
...
#if RXP_HAS_VARIADIC_MACROS
#define RX_TEST_CASE(...)                                                      \
    RXP_EXPAND(RXP_CONCAT(RXP_TEST_CASE_DISPATCH_,                             \
                          RXP_HAS_AT_LEAST_3_ARGS(__VA_ARGS__))(__VA_ARGS__))

#define RXP_TEST_CASE_DISPATCH_0(SUIE_ID, ID) RXP_TEST_CASE_0(SUIE_ID, ID)

#define RXP_TEST_CASE_DISPATCH_1(SUIE_ID, ID, ...)                             \
    RXP_TEST_CASE_1(SUIE_ID, ID, RXP_COUNT_ARGS(__VA_ARGS__), (__VA_ARGS__))
#else
#define RX_TEST_CASE(SUIE_ID, ID) RXP_TEST_CASE_0(SUIE_ID, ID)
#endif

#define RX_TEST_CASE_1(SUIE_ID, ID, _0) RXP_TEST_CASE_1(SUIE_ID, ID, 1, (_0))
...
#define RXP_STRUCT_UPDATE_1(_0) RXP_STRUCT_SET_MEMBER(_0)
...
#if RXP_HAS_VARIADIC_MACROS
#define RXP_ARG(_0, _1, _2, _3, _4, _5, _6, _7, _8, ...) _8

#define RXP_HAS_AT_LEAST_2_ARGS(...)                                           \
    RXP_EXPAND(RXP_ARG(__VA_ARGS__, 1, 1, 1, 1, 1, 1, 1, 0, ))

#define RXP_HAS_AT_LEAST_3_ARGS(...)                                           \
    RXP_EXPAND(RXP_ARG(__VA_ARGS__, 1, 1, 1, 1, 1, 1, 0, 0, ))

#define RXP_COUNT_ARGS(...)                                                    \
    RXP_EXPAND(RXP_ARG(__VA_ARGS__, 8, 7, 6, 5, 4, 3, 2, 1, 0, ))
#endif

#define RXP_FIXTURE_DESC_GET_ID(ID) rxp_fixture_desc_##ID
#define RXP_FIXTURE_GET_UPDATE_FN_ID(ID) rxp_fixture_update_fn_##ID

#define RXP_TEST_SUITE_DESC_GET_ID(ID) rxp_test_suite_desc_##ID
#define RXP_TEST_SUITE_DESC_PTR_GET_ID(ID) rxp_test_suite_desc_ptr_##ID
...
#define RXP_TEST_CASE_CONFIG_DESC_GET_ID(ID) rxp_test_case_config_desc_##ID
...
#if !defined(RX_DISABLE_LOG_STYLING) && defined(_POSIX_C_SOURCE)               \
    && _POSIX_C_SOURCE >= 1
...
#define RXP_LOG(LEVEL, ARGS)                                                   \
    do {                                                                       \
        _Pragma("warning(push)") _Pragma(                                      \
            "warning(disable : 4127)") if (RXP_LOGGING                         \
                                           && (LEVEL) <= RXP_LOGGING_LEVEL)    \
        {                                                                      \
            RX_LOG ARGS;                                                       \
        }                                                                      \
        _Pragma("warning(pop)")                                                \
...
#define RXP_LOG(LEVEL, ARGS)                                                   \
    do {                                                                       \
        _Pragma("GCC diagnostic push")                                         \
            _Pragma("GCC diagnostic ignored \"-Wtautological-compare\"") if (  \
                RXP_LOGGING && (LEVEL) <= RXP_LOGGING_LEVEL)                   \
        {                                                                      \
            RX_LOG ARGS;                                                       \
        }                                                                      \
...
#define RXP_LOG_DEBUG(MSG)                                                     \
    RXP_LOG(RX_LOG_LEVEL_DEBUG, (RX_LOG_LEVEL_DEBUG, __FILE__, __LINE__, MSG))
...
#define RXP_LOG_INFO(MSG)                                                      \
    RXP_LOG(RX_LOG_LEVEL_INFO, (RX_LOG_LEVEL_INFO, __FILE__, __LINE__, MSG))
#define RXP_LOG_INFO_1(FMT, _0)                                                \
    RXP_LOG(RX_LOG_LEVEL_INFO, (RX_LOG_LEVEL_INFO, __FILE__, __LINE__, FMT, _0))
...
#define RXP_LOG_ERROR(MSG)                                                     \
    RXP_LOG(RX_LOG_LEVEL_ERROR, (RX_LOG_LEVEL_ERROR, __FILE__, __LINE__, MSG))
...
#define RXP_LOG_FATAL(MSG)                                                     \
    RXP_LOG(RX_LOG_LEVEL_FATAL, (RX_LOG_LEVEL_FATAL, __FILE__, __LINE__, MSG))
...
#define RXP_DYN_ARRAY_GET_HEADER(BLOCK) ((struct rxp_dyn_array_header *)(BLOCK))
...
extern const struct rxp_test_suite_desc *const
    __start_rxsuite __asm("section$start$__DATA$rxsuite");
extern const struct rxp_test_suite_desc *const
    __stop_rxsuite __asm("section$end$__DATA$rxsuite");
...
#define RXP_TEST_SUITE_REGISTER(NAME)                                          \
    RXP_TEST_SUITE_SECTION                                                     \
    const struct rxp_test_suite_desc *const RXP_TEST_SUITE_DESC_PTR_GET_ID(    \
        NAME)                                                                  \
        = &RXP_TEST_SUITE_DESC_GET_ID(NAME)
...
extern const struct rxp_test_case_desc *const
    __start_rxcase __asm("section$start$__DATA$rxcase");
extern const struct rxp_test_case_desc *const
    __stop_rxcase __asm("section$end$__DATA$rxcase");
...
#define RXP_TEST_CASE_REGISTER(SUITE_NAME, NAME)                               \
    RXP_TEST_CASE_SECTION                                                      \
    const struct rxp_test_case_desc *const RXP_TEST_CASE_DESC_PTR_GET_ID(      \
        SUITE_NAME, NAME)                                                      \
        = &RXP_TEST_CASE_DESC_GET_ID(SUITE_NAME, NAME)
...
typedef void (*rxp_fixture_config_update_fn)(struct rx_fixture_config *);
...
#define RXP_FIXTURE_(ID, SIZE, UPDATE_FN)                                      \
    static const struct rxp_fixture_desc RXP_FIXTURE_DESC_GET_ID(ID)           \
        = {SIZE, UPDATE_FN};                                                   \
                                                                               \
    static const struct rxp_fixture_desc *ID = &RXP_FIXTURE_DESC_GET_ID(ID);

#define RXP_FIXTURE_0(ID, SIZE) RXP_FIXTURE_(ID, SIZE, NULL)

#define RXP_FIXTURE_1(ID, SIZE, ARG_COUNT, ARGS)                               \
    RXP_STRUCT_DEFINE_UPDATE_FN(RXP_FIXTURE_GET_UPDATE_FN_ID(ID),              \
                                struct rx_fixture_config,                      \
                                ARG_COUNT,                                     \
                                ARGS)                                          \
                                                                               \
...
#define RXP_TEST_SUITE_0(ID) RXP_TEST_SUITE_(ID, NULL);
                   ...
                   const struct rx_test_case *test_cases)
{
...
#if RXP_LOG_STYLING
    if (RXP_ISATTY(RXP_FILENO(stderr))) {
        rxp_log_style_get_ansi_code(&style_begin, RXP_LOG_STYLE_YELLOW);
    ...
    summaries
        = (struct rx_summary *)RX_MALLOC(sizeof *summaries * test_case_count);
    if (summaries == NULL) {
    ...
    if (summary_groups == NULL) {
        *summary_group_count = 1;
        for (i = 0; i < summary_count - 1; ++i) {
            *summary_group_count
                += (rx_size)(rxp_compare_summaries_by_test_suite(
                        ...
                        struct rx_test_case *test_cases)
{
    ...
    *test_case_count = 0;
    ...
    i = 0;
    for (c_it = RXP_TEST_CASE_SECTION_BEGIN; c_it != RXP_TEST_CASE_SECTION_END;
         ++c_it) {
...
#if RXP_HAS_VARIADIC_MACROS
#define RXP_DEFINE_TEST(CONDITION, SEVERITY, ...)                              \
...
#define RXP_BOOL_DEFINE_TEST(CONDITION, EXPECTED, OP, SEVERITY, ...)           \
...
#define RXP_INT_DEFINE_COMPARISON_TEST(X1, X2, OP, SEVERITY, ...)              \
...
#define RXP_UINT_DEFINE_COMPARISON_TEST(X1, X2, OP, SEVERITY, ...)             \
...
#define RXP_REAL_DEFINE_COMPARISON_TEST(X1, X2, OP, SEVERITY, ...)             \
...
#define RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1, X2, TOL, OP, SEVERITY, ...)  \
...
#define RXP_STR_DEFINE_COMPARISON_TEST(S1, S2, STR_CASE, OP, SEVERITY, ...)    \
...
#define RXP_PTR_DEFINE_COMPARISON_TEST(X1, X2, OP, SEVERITY, ...)              \
...
#define RXP_PTR_DEFINE_ALIGNMENT_TEST(X, ALIGNMENT, SEVERITY, ...)             \
...
#define RXP_DEFINE_TEST(                                                       \
    CONDITION, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                  \
    rxp_assess_value(RX_PARAM_CONTEXT,                                         \
                     !!(CONDITION),                                            \
                     RXP_TRUE,                                                 \
                     #CONDITION,                                               \
...
#define RXP_BOOL_DEFINE_TEST(                                                  \
    CONDITION, EXPECTED, OP, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)    \
    rxp_bool_assess_value(RX_PARAM_CONTEXT,                                    \
                          !!(CONDITION),                                       \
                          EXPECTED,                                            \
                          #CONDITION,                                          \
...
#define RXP_INT_DEFINE_COMPARISON_TEST(                                        \
    X1, X2, OP, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                 \
    rxp_int_assess_comparison(RX_PARAM_CONTEXT,                                \
                              (X1),                                            \
                              (X2),                                            \
                              OP,                                              \
...
#define RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(                                 \
    X1, X2, TOL, OP, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)            \
    rxp_real_assess_fuzzy_comparison(RX_PARAM_CONTEXT,                         \
                                     (X1),                                     \
                                     (X2),                                     \
                                     (TOL),                                    \
...
#define RXP_STR_DEFINE_COMPARISON_TEST(                                        \
    S1, S2, STR_CASE, OP, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)       \
    rxp_str_assess_comparison(RX_PARAM_CONTEXT,                                \
                              (S1),                                            \
                              (S2),                                            \
                              STR_CASE,                                        \
...
#define RXP_PTR_DEFINE_ALIGNMENT_TEST(                                         \
    X, ALIGNMENT, SEVERITY, MSG, _0, _1, _2, _3, _4, _5, _6, _7)               \
    rxp_ptr_assess_alignment(RX_PARAM_CONTEXT,                                 \
                             (X),                                              \
                             (ALIGNMENT),                                      \
                             #X,                                               \
...
#define RX_BOOL_REQUIRE_TRUE(CONDITION)                                        \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
                         NULL,                                                 \
...
#define RX_INT_REQUIRE_EQUAL(X1, X2)                                           \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
                                   NULL,                                       \
...
#define RX_UINT_REQUIRE_EQUAL(X1, X2)                                          \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
                                    NULL,                                      \
...
#define RX_REAL_REQUIRE_EQUAL(X1, X2)                                          \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
                                    NULL,                                      \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL(X1, X2, TOL)                               \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
                                          RX_FATAL,                            \
...
#define RX_STR_REQUIRE_EQUAL(S1, S2)                                           \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_REQUIRE_EQUAL(X1, X2)                                           \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
                                   NULL,                                       \
...
#define RX_PTR_REQUIRE_ALIGNED(X, ALIGNMENT)                                   \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_FATAL,                                    \
                                  NULL,                                        \
                                  NULL,                                        \
...
#define RX_REQUIRE_MSG(CONDITION, ...)                                         \
    RXP_DEFINE_TEST(CONDITION, RX_FATAL, __VA_ARGS__)

#define RX_CHECK_MSG(CONDITION, ...)                                           \
    RXP_DEFINE_TEST(CONDITION, RX_NONFATAL, __VA_ARGS__)

#define RX_BOOL_REQUIRE_TRUE_MSG(CONDITION, ...)                               \
    RXP_BOOL_DEFINE_TEST(CONDITION, RXP_TRUE, OP, RX_FATAL, __VA_ARGS__)

#define RX_BOOL_CHECK_TRUE_MSG(CONDITION, ...)                                 \
    RXP_BOOL_DEFINE_TEST(CONDITION, RXP_TRUE, OP, RX_NONFATAL, __VA_ARGS__)

#define RX_BOOL_REQUIRE_FALSE_MSG(CONDITION, ...)                              \
    RXP_BOOL_DEFINE_TEST(CONDITION, RXP_FALSE, OP, RX_FATAL, __VA_ARGS__)

#define RX_BOOL_CHECK_FALSE_MSG(CONDITION, ...)                                \
    RXP_BOOL_DEFINE_TEST(CONDITION, RXP_FALSE, OP, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_EQUAL_MSG(X1, X2, ...)                                  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1, X2, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_EQUAL_MSG(X1, X2, ...)                                    \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_NOT_EQUAL_MSG(X1, X2, ...)                              \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_NOT_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_NOT_EQUAL_MSG(X1, X2, ...)                                \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_NOT_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_GREATER_MSG(X1, X2, ...)                                \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_GREATER, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_GREATER_MSG(X1, X2, ...)                                  \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_GREATER, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_LESSER_MSG(X1, X2, ...)                                 \
    RXP_INT_DEFINE_COMPARISON_TEST(X1, X2, RXP_OP_LESSER, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_LESSER_MSG(X1, X2, ...)                                   \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_LESSER, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG(X1, X2, ...)                       \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_GREATER_OR_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG(X1, X2, ...)                         \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_GREATER_OR_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG(X1, X2, ...)                        \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_LESSER_OR_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG(X1, X2, ...)                          \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_LESSER_OR_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_UINT_REQUIRE_EQUAL_MSG(X1, X2, ...)                                 \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1, X2, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)
...
#define RX_UINT_REQUIRE_LESSER_MSG(X1, X2, ...)                                \
    RXP_UINT_DEFINE_COMPARISON_TEST(                                           \
        X1, X2, RXP_OP_LESSER, RX_FATAL, __VA_ARGS__)
...
#define RX_REAL_REQUIRE_EQUAL_MSG(X1, X2, ...)                                 \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1, X2, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG(X1, X2, TOL, ...)                      \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(                                     \
        X1, X2, TOL, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_REAL_CHECK_FUZZY_EQUAL_MSG(X1, X2, TOL, ...)                        \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(                                     \
        X1, X2, TOL, RXP_OP_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_REAL_REQUIRE_FUZZY_NOT_EQUAL_MSG(X1, X2, TOL, ...)                  \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(                                     \
        X1, X2, TOL, RXP_OP_NOT_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_REAL_CHECK_FUZZY_NOT_EQUAL_MSG(X1, X2, TOL, ...)                    \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(                                     \
        X1, X2, TOL, RXP_OP_NOT_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_STR_REQUIRE_EQUAL_MSG(S1, S2, ...)                                  \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_OBEY, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_STR_CHECK_EQUAL_MSG(S1, S2, ...)                                    \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_OBEY, RXP_OP_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_STR_REQUIRE_NOT_EQUAL_MSG(S1, S2, ...)                              \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_OBEY, RXP_OP_NOT_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_STR_CHECK_NOT_EQUAL_MSG(S1, S2, ...)                                \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_OBEY, RXP_OP_NOT_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG(S1, S2, ...)                          \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_IGNORE, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)

#define RX_STR_CHECK_EQUAL_NO_CASE_MSG(S1, S2, ...)                            \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_IGNORE, RXP_OP_EQUAL, RX_NONFATAL, __VA_ARGS__)

#define RX_STR_REQUIRE_NOT_EQUAL_NO_CASE_MSG(S1, S2, ...)                      \
    RXP_STR_DEFINE_COMPARISON_TEST(                                            \
        S1, S2, RXP_STR_CASE_IGNORE, RXP_OP_NOT_EQUAL, RX_FATAL, __VA_ARGS__)
...
#define RX_PTR_REQUIRE_EQUAL_MSG(X1, X2, ...)                                  \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1, X2, RXP_OP_EQUAL, RX_FATAL, __VA_ARGS__)
...
#define RX_PTR_REQUIRE_ALIGNED_MSG(X, ALIGNMENT, ...)                          \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X, ALIGNMENT, RX_FATAL, __VA_ARGS__)

#define RX_PTR_CHECK_ALIGNED_MSG(X, ALIGNMENT, ...)                            \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X, ALIGNMENT, RX_NONFATAL, __VA_ARGS__)
#else /* RXP_HAS_VARIADIC_MACROS */
...
#define RX_REQUIRE_MSG_1(CONDITION, MSG, _0)                                   \
    RXP_DEFINE_TEST(CONDITION,                                                 \
                    RX_FATAL,                                                  \
                    MSG,                                                       \
                    _0,                                                        \
...
#define RX_CHECK_MSG_1(CONDITION, MSG, _0)                                     \
    RXP_DEFINE_TEST(CONDITION,                                                 \
                    RX_NONFATAL,                                               \
                    MSG,                                                       \
                    _0,                                                        \
...
#define RX_REQUIRE_MSG_2(CONDITION, MSG, _0, _1)                               \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_FATAL, MSG, _0, _1, NULL, NULL, NULL, NULL, NULL, NULL)

#define RX_CHECK_MSG_2(CONDITION, MSG, _0, _1)                                 \
    RXP_DEFINE_TEST(CONDITION,                                                 \
                    RX_NONFATAL,                                               \
                    MSG,                                                       \
                    _0,                                                        \
...
#define RX_REQUIRE_MSG_3(CONDITION, MSG, _0, _1, _2)                           \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_FATAL, MSG, _0, _1, _2, NULL, NULL, NULL, NULL, NULL)

#define RX_CHECK_MSG_3(CONDITION, MSG, _0, _1, _2)                             \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_NONFATAL, MSG, _0, _1, _2, NULL, NULL, NULL, NULL, NULL)

#define RX_REQUIRE_MSG_4(CONDITION, MSG, _0, _1, _2, _3)                       \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_FATAL, MSG, _0, _1, _2, _3, NULL, NULL, NULL, NULL)

#define RX_CHECK_MSG_4(CONDITION, MSG, _0, _1, _2, _3)                         \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_NONFATAL, MSG, _0, _1, _2, _3, NULL, NULL, NULL, NULL)

#define RX_REQUIRE_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)                   \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_FATAL, MSG, _0, _1, _2, _3, _4, NULL, NULL, NULL)

#define RX_CHECK_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)                     \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, NULL, NULL, NULL)

#define RX_REQUIRE_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)               \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, NULL, NULL)

#define RX_CHECK_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)                 \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, NULL, NULL)

#define RX_REQUIRE_MSG_7(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6)           \
    RXP_DEFINE_TEST(CONDITION, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_CHECK_MSG_7(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6)             \
    RXP_DEFINE_TEST(                                                           \
        CONDITION, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_REQUIRE_MSG_8(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6, _7)       \
    RXP_DEFINE_TEST(CONDITION, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)

#define RX_CHECK_MSG_8(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6, _7)         \
    RXP_DEFINE_TEST(CONDITION, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)

#define RX_BOOL_REQUIRE_TRUE_MSG_1(CONDITION, MSG, _0)                         \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_1(CONDITION, MSG, _0)                           \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_1(CONDITION, MSG, _0)                        \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_1(CONDITION, MSG, _0)                          \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_2(CONDITION, MSG, _0, _1)                     \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_2(CONDITION, MSG, _0, _1)                       \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_2(CONDITION, MSG, _0, _1)                    \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_2(CONDITION, MSG, _0, _1)                      \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_3(CONDITION, MSG, _0, _1, _2)                 \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_3(CONDITION, MSG, _0, _1, _2)                   \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_3(CONDITION, MSG, _0, _1, _2)                \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_3(CONDITION, MSG, _0, _1, _2)                  \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_4(CONDITION, MSG, _0, _1, _2, _3)             \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_4(CONDITION, MSG, _0, _1, _2, _3)               \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_4(CONDITION, MSG, _0, _1, _2, _3)            \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_4(CONDITION, MSG, _0, _1, _2, _3)              \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)         \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)           \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)        \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_5(CONDITION, MSG, _0, _1, _2, _3, _4)          \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)     \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)    \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_6(CONDITION, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_7(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6) \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_TRUE_MSG_7(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_FALSE_MSG_7(                                           \
    CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6)                                \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_BOOL_CHECK_FALSE_MSG_7(CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_FALSE,                                            \
                         OP,                                                   \
                         RX_NONFATAL,                                          \
...
#define RX_BOOL_REQUIRE_TRUE_MSG_8(                                            \
    CONDITION, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                            \
    RXP_BOOL_DEFINE_TEST(CONDITION,                                            \
                         RXP_TRUE,                                             \
                         OP,                                                   \
                         RX_FATAL,                                             \
...
#define RX_INT_REQUIRE_EQUAL_MSG_1(X1, X2, MSG, _0)                            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_1(X1, X2, MSG, _0)                              \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_1(X1, X2, MSG, _0)                          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_1(X1, X2, MSG, _0)                            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_1(X1, X2, MSG, _0)                           \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_1(X1, X2, MSG, _0)                             \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                 \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                   \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_2(X1, X2, MSG, _0, _1)                      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_2(X1, X2, MSG, _0, _1)                        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_2(X1, X2, MSG, _0, _1)                       \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_2(X1, X2, MSG, _0, _1)                         \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)             \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)               \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)              \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                   \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                     \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)         \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)           \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)              \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)              \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)               \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                 \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)     \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)       \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)              \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)            \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)           \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)             \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4) \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)   \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER_OR_EQUAL,                    \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER_OR_EQUAL,                     \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)          \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)         \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_EQUAL, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_INT_CHECK_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)      \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_NOT_EQUAL_MSG_7(                                        \
    X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)                                   \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_NOT_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_GREATER,                             \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_FATAL,                                   \
...
#define RX_INT_CHECK_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)     \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_EQUAL_MSG_8(                                            \
    X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                               \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_EQUAL, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)

#define RX_INT_CHECK_EQUAL_MSG_8(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)  \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_INT_REQUIRE_GREATER_MSG_8(                                          \
    X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                               \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_GREATER, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)
...
#define RX_INT_REQUIRE_LESSER_MSG_8(                                           \
    X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                               \
    RXP_INT_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_LESSER, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)

#define RX_INT_CHECK_LESSER_MSG_8(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7) \
    RXP_INT_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_LESSER,                              \
                                   RX_NONFATAL,                                \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_1(X1, X2, MSG, _0)                           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_1(X1, X2, MSG, _0)                             \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_1(X1, X2, MSG, _0)                         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_1(X1, X2, MSG, _0)                           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_1(X1, X2, MSG, _0)                          \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_1(X1, X2, MSG, _0)                            \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                  \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                 \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_2(X1, X2, MSG, _0, _1)                     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_2(X1, X2, MSG, _0, _1)                       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_2(X1, X2, MSG, _0, _1)                      \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_2(X1, X2, MSG, _0, _1)                        \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)            \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)              \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)             \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)               \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)               \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                 \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                 \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                  \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                    \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)        \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)          \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)               \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                 \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)             \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)             \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)               \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)              \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)    \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)      \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)             \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)           \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)          \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)            \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_CHECK_GREATER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)  \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4) \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)         \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_UINT_DEFINE_COMPARISON_TEST(                                           \
        X1, X2, RXP_OP_EQUAL, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_UINT_CHECK_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)     \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_CHECK_NOT_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6) \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6) \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_REQUIRE_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_UINT_CHECK_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_UINT_CHECK_EQUAL_MSG_8(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7) \
    RXP_UINT_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_1(X1, X2, MSG, _0)                           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_1(X1, X2, MSG, _0)                             \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_1(X1, X2, MSG, _0)                         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_1(X1, X2, MSG, _0)                           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_1(X1, X2, MSG, _0)                          \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_1(X1, X2, MSG, _0)                            \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                  \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                 \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_OR_EQUAL_MSG_1(X1, X2, MSG, _0)                   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_2(X1, X2, MSG, _0, _1)                     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_2(X1, X2, MSG, _0, _1)                       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_2(X1, X2, MSG, _0, _1)                      \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_2(X1, X2, MSG, _0, _1)                        \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)            \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)              \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)             \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_OR_EQUAL_MSG_2(X1, X2, MSG, _0, _1)               \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)               \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                 \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                 \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_3(X1, X2, MSG, _0, _1, _2)                   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                  \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_3(X1, X2, MSG, _0, _1, _2)                    \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)        \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)          \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_OR_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)               \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                 \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)             \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)             \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)               \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)              \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)    \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)      \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_OR_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)             \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)           \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)          \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)            \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_CHECK_GREATER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)  \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER_OR_EQUAL,                   \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4) \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_OR_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER_OR_EQUAL,                    \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)         \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)       \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_REAL_DEFINE_COMPARISON_TEST(                                           \
        X1, X2, RXP_OP_EQUAL, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_REAL_CHECK_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)     \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_CHECK_NOT_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6) \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_NOT_EQUAL,                          \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6) \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_GREATER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)   \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_GREATER,                            \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_FATAL,                                  \
...
#define RX_REAL_CHECK_LESSER_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_LESSER,                             \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_CHECK_EQUAL_MSG_8(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7) \
    RXP_REAL_DEFINE_COMPARISON_TEST(X1,                                        \
                                    X2,                                        \
                                    RXP_OP_EQUAL,                              \
                                    RX_NONFATAL,                               \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_1(X1, X2, TOL, MSG, _0)                \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_CHECK_FUZZY_EQUAL_MSG_1(X1, X2, TOL, MSG, _0)                  \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_NOT_EQUAL_MSG_1(X1, X2, TOL, MSG, _0)            \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_CHECK_FUZZY_NOT_EQUAL_MSG_1(X1, X2, TOL, MSG, _0)              \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_2(X1, X2, TOL, MSG, _0, _1)            \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_CHECK_FUZZY_EQUAL_MSG_2(X1, X2, TOL, MSG, _0, _1)              \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_NOT_EQUAL_MSG_2(X1, X2, TOL, MSG, _0, _1)        \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_CHECK_FUZZY_NOT_EQUAL_MSG_2(X1, X2, TOL, MSG, _0, _1)          \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_3(X1, X2, TOL, MSG, _0, _1, _2)        \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_CHECK_FUZZY_EQUAL_MSG_3(X1, X2, TOL, MSG, _0, _1, _2)          \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_NOT_EQUAL_MSG_3(X1, X2, TOL, MSG, _0, _1, _2)    \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_CHECK_FUZZY_NOT_EQUAL_MSG_3(X1, X2, TOL, MSG, _0, _1, _2)      \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_4(X1, X2, TOL, MSG, _0, _1, _2, _3)    \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_CHECK_FUZZY_EQUAL_MSG_4(X1, X2, TOL, MSG, _0, _1, _2, _3)      \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_CHECK_FUZZY_NOT_EQUAL_MSG_4(X1, X2, TOL, MSG, _0, _1, _2, _3)  \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_NOT_EQUAL,                    \
...
#define RX_REAL_CHECK_FUZZY_EQUAL_MSG_5(X1, X2, TOL, MSG, _0, _1, _2, _3, _4)  \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_6(                                     \
    X1, X2, TOL, MSG, _0, _1, _2, _3, _4, _5)                                  \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_7(                                     \
    X1, X2, TOL, MSG, _0, _1, _2, _3, _4, _5, _6)                              \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_REAL_REQUIRE_FUZZY_EQUAL_MSG_8(                                     \
    X1, X2, TOL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                          \
    RXP_REAL_DEFINE_FUZZY_COMPARISON_TEST(X1,                                  \
                                          X2,                                  \
                                          TOL,                                 \
                                          RXP_OP_EQUAL,                        \
...
#define RX_STR_REQUIRE_EQUAL_MSG_1(S1, S2, MSG, _0)                            \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_1(S1, S2, MSG, _0)                              \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_1(S1, S2, MSG, _0)                        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_1(S1, S2, MSG, _0)                          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG_1(S1, S2, MSG, _0)                    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_1(S1, S2, MSG, _0)                      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_NO_CASE_MSG_1(S1, S2, MSG, _0)                \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_NO_CASE_MSG_1(S1, S2, MSG, _0)                  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_2(S1, S2, MSG, _0, _1)                        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_2(S1, S2, MSG, _0, _1)                          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_2(S1, S2, MSG, _0, _1)                    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_2(S1, S2, MSG, _0, _1)                      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG_2(S1, S2, MSG, _0, _1)                \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_2(S1, S2, MSG, _0, _1)                  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_NO_CASE_MSG_2(S1, S2, MSG, _0, _1)            \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_NO_CASE_MSG_2(S1, S2, MSG, _0, _1)              \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_3(S1, S2, MSG, _0, _1, _2)                    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_3(S1, S2, MSG, _0, _1, _2)                      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_3(S1, S2, MSG, _0, _1, _2)                \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_3(S1, S2, MSG, _0, _1, _2)                  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG_3(S1, S2, MSG, _0, _1, _2)            \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_3(S1, S2, MSG, _0, _1, _2)              \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_NO_CASE_MSG_3(S1, S2, MSG, _0, _1, _2)        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_NO_CASE_MSG_3(S1, S2, MSG, _0, _1, _2)          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_4(S1, S2, MSG, _0, _1, _2, _3)                \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_4(S1, S2, MSG, _0, _1, _2, _3)                  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_4(S1, S2, MSG, _0, _1, _2, _3)            \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_4(S1, S2, MSG, _0, _1, _2, _3)              \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG_4(S1, S2, MSG, _0, _1, _2, _3)        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_4(S1, S2, MSG, _0, _1, _2, _3)          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_NO_CASE_MSG_4(S1, S2, MSG, _0, _1, _2, _3)    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_NO_CASE_MSG_4(S1, S2, MSG, _0, _1, _2, _3)      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)            \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)              \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_NO_CASE_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_NOT_EQUAL_NO_CASE_MSG_5(S1, S2, MSG, _0, _1, _2, _3, _4)  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_6(S1, S2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_6(S1, S2, MSG, _0, _1, _2, _3, _4, _5)          \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_6(S1, S2, MSG, _0, _1, _2, _3, _4, _5)    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_6(S1, S2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_EQUAL_NO_CASE_MSG_6(S1, S2, MSG, _0, _1, _2, _3, _4, _5)  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_IGNORE,                        \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_EQUAL_MSG_7(S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_7(S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6)      \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_REQUIRE_NOT_EQUAL_MSG_7(                                        \
    S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6)                                   \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_CHECK_NOT_EQUAL_MSG_7(S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_NOT_EQUAL,                           \
...
#define RX_STR_REQUIRE_EQUAL_MSG_8(                                            \
    S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                               \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_STR_CHECK_EQUAL_MSG_8(S1, S2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)  \
    RXP_STR_DEFINE_COMPARISON_TEST(S1,                                         \
                                   S2,                                         \
                                   RXP_STR_CASE_OBEY,                          \
                                   RXP_OP_EQUAL,                               \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_1(X1, X2, MSG, _0)                            \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_1(X1, X2, MSG, _0)                              \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                        \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_1(X1, X2, MSG, _0)                          \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                        \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                          \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                    \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_2(X1, X2, MSG, _0, _1)                      \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                    \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                      \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_3(X1, X2, MSG, _0, _1, _2)                  \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)                  \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)            \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_4(X1, X2, MSG, _0, _1, _2, _3)              \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)            \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)              \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)        \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_5(X1, X2, MSG, _0, _1, _2, _3, _4)          \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)        \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)          \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)    \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_FATAL,                                   \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_6(X1, X2, MSG, _0, _1, _2, _3, _4, _5)      \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)    \
    RXP_PTR_DEFINE_COMPARISON_TEST(                                            \
        X1, X2, RXP_OP_EQUAL, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_PTR_CHECK_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)      \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_CHECK_NOT_EQUAL_MSG_7(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6)  \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_NOT_EQUAL,                           \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_CHECK_EQUAL_MSG_8(X1, X2, MSG, _0, _1, _2, _3, _4, _5, _6, _7)  \
    RXP_PTR_DEFINE_COMPARISON_TEST(X1,                                         \
                                   X2,                                         \
                                   RXP_OP_EQUAL,                               \
                                   RX_NONFATAL,                                \
...
#define RX_PTR_REQUIRE_ALIGNED_MSG_1(X, ALIGNMENT, MSG, _0)                    \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_FATAL,                                    \
                                  MSG,                                         \
...
#define RX_PTR_CHECK_ALIGNED_MSG_1(X, ALIGNMENT, MSG, _0)                      \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_NONFATAL,                                 \
                                  MSG,                                         \
...
#define RX_PTR_REQUIRE_ALIGNED_MSG_2(X, ALIGNMENT, MSG, _0, _1)                \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_FATAL,                                    \
                                  MSG,                                         \
...
#define RX_PTR_CHECK_ALIGNED_MSG_2(X, ALIGNMENT, MSG, _0, _1)                  \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_NONFATAL,                                 \
                                  MSG,                                         \
...
#define RX_PTR_REQUIRE_ALIGNED_MSG_3(X, ALIGNMENT, MSG, _0, _1, _2)            \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, NULL, NULL, NULL, NULL, NULL)

#define RX_PTR_CHECK_ALIGNED_MSG_3(X, ALIGNMENT, MSG, _0, _1, _2)              \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_NONFATAL,                                 \
                                  MSG,                                         \
...
#define RX_PTR_REQUIRE_ALIGNED_MSG_4(X, ALIGNMENT, MSG, _0, _1, _2, _3)        \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, _3, NULL, NULL, NULL, NULL)

#define RX_PTR_CHECK_ALIGNED_MSG_4(X, ALIGNMENT, MSG, _0, _1, _2, _3)          \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(X,                                           \
                                  ALIGNMENT,                                   \
                                  RX_NONFATAL,                                 \
                                  MSG,                                         \
...
#define RX_PTR_REQUIRE_ALIGNED_MSG_5(X, ALIGNMENT, MSG, _0, _1, _2, _3, _4)    \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, _3, _4, NULL, NULL, NULL)

#define RX_PTR_CHECK_ALIGNED_MSG_5(X, ALIGNMENT, MSG, _0, _1, _2, _3, _4)      \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, NULL, NULL, NULL)

#define RX_PTR_REQUIRE_ALIGNED_MSG_6(                                          \
    X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5)                                 \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, NULL, NULL)

#define RX_PTR_CHECK_ALIGNED_MSG_6(X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5)  \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, NULL, NULL)

#define RX_PTR_REQUIRE_ALIGNED_MSG_7(                                          \
    X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5, _6)                             \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_PTR_CHECK_ALIGNED_MSG_7(                                            \
    X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5, _6)                             \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, _6, NULL)

#define RX_PTR_REQUIRE_ALIGNED_MSG_8(                                          \
    X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                         \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_FATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)

#define RX_PTR_CHECK_ALIGNED_MSG_8(                                            \
    X, ALIGNMENT, MSG, _0, _1, _2, _3, _4, _5, _6, _7)                         \
    RXP_PTR_DEFINE_ALIGNMENT_TEST(                                             \
        X, ALIGNMENT, RX_NONFATAL, MSG, _0, _1, _2, _3, _4, _5, _6, _7)
